...
export const productsListColumn: ColumnType<IProducts>[] = [
  ...
  },
  {
    key: 'priceDoc',
    dataIndex: 'priceDoc',
    title: 'Mijozga sotilish narxi',
    align: 'center',
    render: (value, record) => record?.prices?.client,
  },
  {
    key: 'priceFer',
    dataIndex: 'priceFer',
    title: 'Fermerga sotilish narxi',
    align: 'center',
    render: (value, record) => record?.prices?.farmer,
  },
  {
    key: 'priceDoc',
    dataIndex: 'priceDoc',
    title: 'Doktorga sotilish narxi',
    align: 'center',
    render: (value, record) => record?.prices?.doctor,
  },
  {
    key: 'totalPrice',
